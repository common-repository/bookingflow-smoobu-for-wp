			...
			<tbody>
				<tr>
					...
					<td>
						...
						<p class="description"><?php echo wp_kses_post( '<b>Warning!</b> Changing the theme will revoke all style customizations.', 'smoobu-calendar' ); ?></p>
					</td>
				</tr>
				<tr>
					<th scope="row">
					...
					<td>
						...
						<p class="description">
							<?php esc_html_e( 'If checked, calendar will be always stretched to the width of the container.', 'posts-validation' ); ?>
						</P>
					</td>
				</tr>
			</tbody>
					...
					<tbody>
						<tr>
							...
							<td>
								...
								<p class="description">
									<?php esc_html_e( 'If checked, settings below will be used instead of default theme settings.', 'posts-validation' ); ?>
								</P>
							</td>
						</tr>
						<tr>
